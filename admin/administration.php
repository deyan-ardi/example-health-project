...
<body>
	...
	<header class="p-3 border-bottom">
		<div class="">
			<div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
				<a href="/" class="ms-0 d-flex align-items-center me-lg-auto text-dark text-decoration-none">
					<svg class="bi me-2" width="40" height="32" role="img" aria-label="Bootstrap">
						<use xlink:href="#bootstrap" />
					</svg>
				</a>
				<div class="col-12 col-lg-auto me-lg-3 text-capitalize">
					<?php
          $welcome= '<p>Wellcome, ' . $_SESSION['username'] . '</p>';
          echo $welcome;
        ?>
				</div>
				<div class="dropdown text-end">
					<a href="#" class="d-block link-dark text-decoration-none dropdown-toggle pb-2"
		  ...
		  <div class="card-body p-5">
			<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" class="needs-validation" name="save" novalidate="" autocomplete="off">
				<div class="mb-3">
					...
					<input id="username" type="text" class="form-control text-capitalize" name="username" required autofocus>
				...
				<div class="text-center">
					<button type="submit" name="save" class="btn btn-primary me-auto px-5">
						Save
					</button>
				</div>
			</form>
	...
	<div class="col-md-8">
		<div class="card">
		<div class="card-header" >Data Administrator</div>
		<div class="card-body pt-2 table-responsive" >
            <table class="table table-fixed" style="max-height:200px;">
				<thead>
					<tr>
					<th class="col-3" scope="col">ID</th>
					<th class="col-3" scope="col">Username</th>
					<th class="col-3" scope="col">Password</th>
					<th class="col-3" scope="col">Created At</th>
					</tr>
				</thead>
				<tbody>
					<?php
